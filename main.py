...
import os
from utils.utils import process_new_papers, prompt_crawl_arxiv
...
def main():
    ...
    if mode == '1':
        ...
        max_result = input("Please input max_result (default = 10): ") or "10"
        prompt_crawl_arxiv(keyword, int(max_result))
    elif mode == '2':
